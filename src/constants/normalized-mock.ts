...
export const normalizedRestaurants: Interfaces.RestaurantsNorm[] = [
  {
...
export const normalizedDishes: Interfaces.DishNorm[] = [
  {
...
export const normalizedReviews: Interfaces.ReviewNorm[] = [
  {
...
export const normalizedUsers: Interfaces.UserNorm[] = [
  {
